...
category: gatsby
featuredImage: ./images/netlify-cms.png
sections:
  [
    { id: "contexto", title: "Contexto" },
    { id: "netlify-cms-vs-netlify", title: "Netlify CMS vs Netlify" },
    {
      id: "adicionando-arquivo-de-configuração",
      title: "Adicionando arquivo de configuração",
    },
    {
      id: "adicionando-novos-caminhos-no-gatsby-config",
      title: "Adicionando novos caminhos no Gatsby Config",
    },
    {
      id: "acessando-administração-do-netlify-cms",
      title: "Acessando Administração do Netlify CMS",
    },
  ]
---
